   ...
   {[...Array(2)].map((e, i) =>(
    <>
      ...
      <div className="top"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUC-_2I4_775RSeEIHfXH909ZeQw-7-fzucMuMqrI-O_GeIwZrIJwr9iyTCpTdOsc3_90&usqp=CAU"></img></div>
          <div className='bottom'><span>50 ლარი</span><button>Buy it</button></div>
      </div>
      ...
      <div className='bottom'><span>60 ლარი</span><button>Buy it</button></div>
      </div> 
      ...
      <div className='bottom'><span>58 ლარი</span><button>Buy it</button></div>
      </div> 
      ...
      <div className='bottom'><span>45 ლარი</span><button>Buy it</button></div>
      </div> 
      ...
      <div className='bottom'><span>40 ლარი</span><button>Buy it</button></div>
      </div> 
      ...
      <div className='bottom'><span>39 ლარი </span><button>Buy it</button>
      </div>
      </div> 
    </>  
  ))}
